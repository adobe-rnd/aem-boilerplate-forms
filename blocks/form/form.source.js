...
// Re-export subscribe so the generated form-bundle(.min).js exposes it at the
// top level — the rules/index.js shim re-exports subscribe from form-bundle.min.js
// to give custom components the same formSubscriptions Map instance as the
// bundle's inlined rules/index.source.js.
export { subscribe } from './rules/index.source.js';
...
export default async function decorate(block) {
  ...
  if (formDef) {
    ...
    if (isDocumentBasedForm(formDef)) {
      ...
      loadFormCustomStyles(formDef);
      afModule = await import('./rules/index.source.js');
